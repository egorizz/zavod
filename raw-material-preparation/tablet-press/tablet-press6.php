    ...
    <div class="section-outer outer-equipment">
        <div class="section-inner">
            <div class="bread-crumbs">
                ...
                <div class="bread-crumbs-title">Таблеточный пресс UNIK I FC</div>
            </div>
        </div>
        ...
        <div class="options_another">
            <div class="options_another-wrap_alt">
                <div class="material">
                    <h1>Таблеточный пресс UNIK I FC</h1>
                </div>
                                    ...
                                    <form class="form">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="hidden" name="name" value="Таблеточный пресс UNIK I FC">
                        ...
                        <div class="content-wrap">
                            <div class="text">
                                ...
                                <ul class="list">
                                    ...
                                    <li class="list-item">
                                        Револьверная головка с червячной системой привода и червячным кольцом
                                    </li>
                                    <li class="list-item">
                    ...
                    <div class="content-tab">
                        <table>
                            ...
                            <tr>
                                ...
                                <td colspan="3">1024х1024х1800</td>
                            </tr>
                            <tr>
